      ...
      <div className="container-custom">
        <AnimatedSection direction="fade" className="text-center mb-16">
          <div className="inline-block mb-4 px-4 py-2 bg-primary-50 rounded-full">
            <span className="text-sm font-semibold text-primary-700">Témoignages</span>
          </div>
          ...
          <a
            ...
            className="inline-flex items-center gap-2 text-primary-600 hover:text-primary-700 font-semibold transition-all duration-300 transform hover:scale-105"
          >
            Écrire un avis
        ...
        <div className="px-4 md:px-8 lg:px-12">
          ...
          >
            {reviews.map((review) => (
              <div
                key={review.id}
                className="bg-light-200 rounded-2xl shadow-lg p-8 hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-3 group border border-neutral-200 hover:border-primary-300 h-full flex flex-col"
              >
