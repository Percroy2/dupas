  ...
  return (
    <footer className="bg-gradient-to-br from-black via-secondary-700 to-black text-white relative overflow-hidden">
      ...
      <div className="container-custom section-padding relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-16">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/" className="text-gray-300 hover:text-white transition-all duration-300 inline-block transform hover:translate-x-2">
                  Accueil
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <a href={`tel:${contactInfo.phone}`} className="text-gray-300 hover:text-white transition-all duration-300">
                  {contactInfo.phone}
                </a>
              </li>
              <li className="flex items-start gap-3">
                ...
                <a href={`mailto:${contactInfo.email}`} className="text-gray-300 hover:text-white transition-all duration-300 break-all">
                  {contactInfo.email}
                </a>
              </li>
        ...
        <div className="mt-12 pt-8 border-t-2 border-gray-700">
          ...
          <div className="flex flex-wrap gap-4">
            <a
              ...
              className="bg-white/10 hover:bg-white/20 text-white px-6 py-3 rounded-xl font-semibold transition-all duration-300 transform hover:scale-105 hover:shadow-lg backdrop-blur-sm border border-white/20"
              aria-label="Facebook"
            >
              Facebook
            </a>
        ...
        {/* Copyright */}
        <div className="mt-12 pt-8 border-t-2 border-gray-700 text-center">
